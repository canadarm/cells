...
scales:
scalep:
    dc.b    6, 0,2,4,5,7,9,12,14,16,17,19,21,0,0,0
scale1:
    dc.b    6, 0,2,4,7,9,10,12,14,16,19,21,22,0,0,0
scale3:
    dc.b    6, 0,3,5,7,8,10,12,15,17,19,20,22,0,0,0
scale4:
    dc.b    6, 0,2,4,7,9,11,12,14,16,19,21,23,0,0,0
scale5:
    dc.b    5, 0,2,5,7,10,12,14,17,19,22,0,0,0,0,0
scale6:
    dc.b    7, 0,1,3,5,6,8,10,12,13,15,17,18,20,22,0
scale7:
    dc.b    6, 0,1,3,5,6,8,12,13,15,17,18,20,0,0,0
